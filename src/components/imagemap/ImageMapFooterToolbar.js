...
class ImageMapFooterToolbar extends Component {
    ...
    onOpenSavePanel = () => {
        this.setState(prev => ({
            openSavePanel: !prev.openSavePanel,
        }));
    }
    ...
    render() {
        const { canvasRef, preview, zoomRatio, onChangePreview, onDownload, readOnly, editable } = this.props;
        ...
        return (
            <React.Fragment>
                <SavePanel
                    ...
                    open={this.state.openSavePanel}
                    onSave={this.props.onSave}
                    onSaveImage={this.props.onSaveImage}
                    onOpenSavePanel={this.onOpenSavePanel}
                    getSavableObject={this.props.getSavableObject}
                />
                <div
                    className="rde-editor-footer-toolbar-zoom"
                    style={extraToolStyles}
                >
                    <Button.Group>
                        <CommonButton
